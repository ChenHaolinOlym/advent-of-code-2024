...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `79.1µs` | `85.6µs` |
| [Day 2](./src/bin/02.rs) | `148.7µs` | `220.1µs` |
| [Day 3](./src/bin/03.rs) | `470.4µs` | `419.3µs` |
| [Day 4](./src/bin/04.rs) | `92.4µs` | `44.9µs` |
| [Day 5](./src/bin/05.rs) | `315.9µs` | `451.7µs` |
| [Day 6](./src/bin/06.rs) | `47.5µs` | `82.6ms` |
| [Day 7](./src/bin/07.rs) | `4.4ms` | `12.6s` |
| [Day 8](./src/bin/08.rs) | `35.0µs` | `107.4µs` |
